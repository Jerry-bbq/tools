...
(() => {
  ...
  var Fe = (t, e, n, r) => {
    if ((e && typeof e == 'object') || typeof e == 'function') for (let i of Oe(e)) !Re.call(t, i) && i !== n && ne(t, i, { get: () => e[i], enumerable: !(r = Ie(e, i)) || r.enumerable });
    return t;
  };
  var De = (t, e, n) => ((n = t != null ? Pe(_e(t)) : {}), Fe(e || !t || !t.__esModule ? ne(n, 'default', { value: t, enumerable: !0 }) : n, t));
  var ae = Me((se, oe) => {
    (function () {
      var t = function (e) {
        var n = new t.Builder();
...
`,
      ...
      (t.stemmer = (function () {
        var e = { ational: 'ate', tional: 'tion', enci: 'ence', anci: 'ance', izer: 'ize', bli: 'ble', alli: 'al', entli: 'ent', eli: 'e', ousli: 'ous', ization: 'ize', ation: 'ate', ator: 'ate', alism: 'al', iveness: 'ive', fulness: 'ful', ousness: 'ous', aliti: 'al', iviti: 'ive', biliti: 'ble', logi: 'log' },
          ...
          V = function (c) {
            ...
            if (((T = c.substr(0, 1)), T == 'y' && (c = T.toUpperCase() + c.substr(1)), (h = L), (x = p), h.test(c) ? (c = c.replace(h, '$1$2')) : x.test(c) && (c = c.replace(x, '$1$2')), (h = m), (x = S), h.test(c))) {
              var E = h.exec(c);
              (h = v), h.test(E[1]) && ((h = w), (c = c.replace(h, '')));
            } else if (x.test(c)) {
              var E = x.exec(c);
              (y = E[1]), (x = g), x.test(y) && ((c = y), (x = k), (O = _), (M = H), x.test(c) ? (c = c + 'e') : O.test(c) ? ((h = w), (c = c.replace(h, ''))) : M.test(c) && (c = c + 'e'));
            }
            if (((h = A), h.test(c))) {
              var E = h.exec(c);
              (y = E[1]), (c = y + 'i');
            ...
            if (s.editsRemaining != 0) {
              ...
              if (s.str.length > 1) {
                var d = s.str.charAt(0),
                  v = s.str.charAt(1),
                  f;
                v in s.node.edges ? (f = s.node.edges[v]) : ((f = new t.TokenSet()), (s.node.edges[v] = f)), s.str.length == 1 && (f.final = !0), i.push({ node: f, editsRemaining: s.editsRemaining - 1, str: d + s.str.slice(2) });
              }
            }
          }
          return r;
              ...
              for (var d = s[u], v = 0; v < l; v++) {
                ...
                if (f == d || d == '*') {
                  var b = r.node.edges[f],
                    ...
                    L = b.final && g.final,
                    p = void 0;
                  f in r.output.edges ? ((p = r.output.edges[f]), (p.final = p.final || L)) : ((p = new t.TokenSet()), (p.final = L), (r.output.edges[f] = p)), i.push({ qNode: g, output: p, node: b });
                }
              }
          }
          return n;
              ...
              for (var S = 0; S < L.length; S++)
                for (var w = L[S], k = this.invertedIndex[w], _ = k._index, p = 0; p < u.fields.length; p++) {
                  var m = u.fields[p],
                    ...
                    j = w + '/' + m,
                    $ = new t.Set(A);
                  if ((u.presence == t.Query.presence.REQUIRED && ((v = v.union($)), o[m] === void 0 && (o[m] = t.Set.complete)), u.presence == t.Query.presence.PROHIBITED)) {
      ...
      (t.Builder = function () {
        ...
        (t.Builder.prototype.createFieldVectors = function () {
          for (var e = {}, n = Object.keys(this.fieldTermFrequencies), r = n.length, i = Object.create(null), s = 0; s < r; s++) {
            for (var o = t.FieldRef.fromString(n[s]), a = o.fieldName, l = this.fieldLengths[o], u = new t.Vector(), d = this.fieldTermFrequencies[o], v = Object.keys(d), f = v.length, b = this._fields[a].boost || 1, g = this._documents[o.docRef].boost || 1, L = 0; L < f; L++) {
              var p = v[L],
                m = d[p],
                ...
                k,
                _;
              i[p] === void 0 ? ((w = t.idf(this.invertedIndex[p], this.documentCount)), (i[p] = w)) : (w = i[p]), (k = (w * ((this._k1 + 1) * m)) / (this._k1 * (1 - this._b + this._b * (l / this.averageFieldLength[a])) + m)), (k *= b), (k *= g), (_ = Math.round(k * 1e3) / 1e3), u.insert(S, _);
            }
            e[o] = u;
          }
          this.fieldVectors = e;
  ...
  function Ae(t, e, n, r) {
    ...
    n.addEventListener('keydown', (s) => {
      (i = !0), s.key == 'Enter' ? Ve(e, n) : s.key == 'Escape' ? n.blur() : s.key == 'ArrowUp' ? ue(e, -1) : s.key === 'ArrowDown' ? ue(e, 1) : (i = !1);
    }),
  ...
  me && 'ontouchstart' in document.documentElement && ((He = !0), (F = 'touchstart'), (pe = 'touchmove'), (B = 'touchend'));
  ...
  var X = class extends C {
    constructor(e) {
      super(e), (this.className = this.el.dataset.toggle || ''), this.el.addEventListener(B, (n) => this.onPointerUp(n)), this.el.addEventListener('click', (n) => n.preventDefault()), document.addEventListener(F, (n) => this.onDocumentPointerDown(n)), document.addEventListener(B, (n) => this.onDocumentPointerUp(n));
    }
    setActive(e) {
...
`),
  ...
  function Ee(t, e, n) {
    if (t.path) {
      ...
      (r.href = Le + t.path), n && (r.className = n), location.href === r.href && r.classList.add('current'), t.kind && (r.innerHTML = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" class="tsd-kind-icon"><use href="#icon-${t.kind}"></use></svg>`), (r.appendChild(document.createElement('span')).textContent = t.text);
